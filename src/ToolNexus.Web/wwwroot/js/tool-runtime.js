import { runtimeObserver } from '/js/runtime/runtime-observer.js';
import { dependencyLoader as defaultDependencyLoader } from '/js/runtime/dependency-loader.js';
...
import { createRuntimeMigrationLogger } from '/js/runtime/runtime-migration-logger.js';
...
import { runtimeIncidentReporter } from '/js/runtime/runtime-incident-reporter.js';
import { createAutoToolRuntimeModule } from '/js/runtime/tool-auto-runtime.js';
import { useUnifiedToolControl as useUnifiedControlAdapter } from '/js/runtime/tool-unified-control-runtime.js';
import { createToolContainerManager, normalizeToolMountMode } from '/js/runtime/tool-container-manager.js';
import { createRuntimeCrashOverlay } from '/js/runtime/runtime-crash-overlay.js';
import { guardInvalidLifecycleResult } from '/js/runtime/tool-execution-normalizer.js';
import { assertDomContractRootsUnchanged, freezeDomContractRoots } from '/js/runtime/tool-dom-contract-guard.js';
import { isModuleContractError, validateModuleContract } from '/js/runtime/module-contract-validator.js';
import { validateExecutionUiLaw as defaultExecutionUiLawValidator } from '/js/runtime/execution-ui-law-validator.js';
import { validateExecutionDensity as defaultExecutionDensityValidator, writeExecutionDensityReport as defaultWriteExecutionDensityReport } from '/js/runtime/execution-density-validator.js';
import { applyExecutionIntelligence as defaultApplyExecutionIntelligence } from '/js/runtime/intelligence/execution-intelligence-engine.js';
import { applyAiRuntimeOrchestrator as defaultApplyAiRuntimeOrchestrator } from '/js/runtime/orchestrator/ai-runtime-orchestrator.js';
import { applyRuntimePolicy as defaultApplyRuntimePolicy } from '/js/runtime/policy/runtime-policy-actuator.js';
import { importRuntimeModule, validateRuntimeModulePath } from '/js/runtime/runtime-import-integrity.js';
import { loadToolIndex as defaultLoadToolIndex, resolveTool as defaultResolveToolFromIndex, resolveToolModule as defaultResolveToolModuleFromIndex } from '/js/runtime/tool-index.js';
import { loadToolModule as defaultLoadToolModule } from '/js/runtime/tool-module-loader.js';
import { resolveToolModuleFromPack } from '/js/runtime/tool-pack/tool-pack-resolver.js';
import { getToolDefinition as defaultGetToolDefinition, loadToolRegistry as defaultLoadToolRegistry } from '/js/runtime/registry/tool-registry-loader.js';
import { createToolStateMachine as defaultCreateToolStateMachine } from '/js/runtime/tool-state-machine.js';
import { createSchemaToolModule } from '/js/runtime/schema-engine/schema-tool-engine.js';
import { manifestPhase } from '/js/runtime/phases/manifest-phase.js';
import { domPhase } from '/js/runtime/phases/dom-phase.js';
import { modulePhase } from '/js/runtime/phases/module-phase.js';
import { mountPhase } from '/js/runtime/phases/mount-phase.js';
import { recoveryPhase } from '/js/runtime/phases/recovery-phase.js';
import { emitRuntimeEvent } from '/js/runtime/telemetry/runtime-event-logger.js';
import { TR_BOOTSTRAP_START, TR_EXECUTION_COMPLETE, TR_EXECUTION_START, TR_MANIFEST_LOADED, TR_MODULE_IMPORTED, TR_RUNTIME_ERROR, TR_TEMPLATE_MOUNTED } from '/js/runtime/telemetry/runtime-event-types.js';
