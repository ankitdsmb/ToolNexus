...
namespace ToolNexus.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialContentBaseline : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            {
                migrationBuilder.Sql(@"ALTER TABLE ""ToolCategories"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolContents"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolExamples"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolFaqs"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolFeatures"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolRelated"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolSteps"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
                migrationBuilder.Sql(@"ALTER TABLE ""ToolUseCases"" ALTER COLUMN ""Id"" ADD GENERATED BY DEFAULT AS IDENTITY;");
            }
        }
