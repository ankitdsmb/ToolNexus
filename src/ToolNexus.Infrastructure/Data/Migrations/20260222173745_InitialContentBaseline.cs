...
namespace ToolNexus.Infrastructure.Data.Migrations
{
    ...
    public partial class InitialContentBaseline : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            {
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolCategories");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolContents");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolExamples");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolFaqs");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolFeatures");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolRelated");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolSteps");
                AddIdentityByDefaultIfMissing(migrationBuilder, "ToolUseCases");
            }
        }


        private static void AddIdentityByDefaultIfMissing(MigrationBuilder migrationBuilder, string tableName)
        {
                ...
                BEGIN
                    IF EXISTS (
                        ...
                        WHERE table_schema = current_schema()
                          ...
                          AND is_identity = 'NO')
                    THEN
                        EXECUTE format('ALTER TABLE %I ALTER COLUMN %I ADD GENERATED BY DEFAULT AS IDENTITY', '{tableName}', 'Id');
                    END IF;
                END $$;
                """);
        }
